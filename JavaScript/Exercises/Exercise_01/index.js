...
// console.log(`Answer 2 => ${getStringLength('Shivaji')}`);
...
function calculateNums(num1, num2){
    ...
    // console.log(`Sum: ${num1 + num2}`); // Sum: 71
    // console.log(`Difference: ${num1 - num2}`); // Difference: 67
    // console.log(`Product: ${num1 * num2}`); // Product: 138
    // console.log(`Quotient: ${num1 / num2}`); // 34.5
    // console.log(`Quotient: ${num1 % num2}`); // remainder 1
}
calculateNums(69, 2);
...
// console.log(`Answer 5 => Reverse String ${reverseString('Shivaji')}`);
