...
// syntax :-
//    function printCounting(parameter) {
...
let a =1;
x = 'a';
// console.log(x); // aise is liye hua ki js ek dynamic laguase hain.
...
// console.log(interest(1000,8)); // default parameter ka mtlb ye hota jo parameter me value add ho jaise r=5
...
// try and catch ka use hum code me error aane se bahane ke liye use krte hain.
...
// scope :-
// diff b/w let and var :- let ka lifetime(scope) bs block ke undar tk hota h aur var ka lifetime(scope) block ke undar aur block ke baar dono tarah rhta hain.
